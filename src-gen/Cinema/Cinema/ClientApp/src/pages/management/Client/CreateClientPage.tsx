...
import { CreateClientRequestModel } from "../../../api/requestModels/CreateClientRequestModel";
...
const CreateClientPage = () => {
	...
	const submit = async () => {
        ...
        const result = await httpPost<CreateClientRequestModel>("/Client", {
            name: name, age: age, height: height, isVip: isVip, discount: discount
        } as CreateClientRequestModel);
                    ...
                    <Grid container style={{width: "100%", minHeight: "100vh"}} justify="center" alignItems="center">
                        <Grid item xs={10} sm={8} md={6} lg={4} xl={4}>
                            <Card style={{width: "100%", padding: "20px", display: "flex", justifyContent: "center", flexDirection: "column", textAlign: "center"}}> 
                                <Typography style={{paddingBottom: "10px"}} variant="h5">Create Client</Typography>
                                {success
